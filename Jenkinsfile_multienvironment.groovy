        ...
        stage('Build Binding Extensions') {
            ...
            steps {
                script {
                    ...
                    env.ARM_SUBSCRIPTION_ID = envvariables."${params.environment}"['ARM_SUBSCRIPTION_ID']
                    env.ARM_CLIENT_ID = envvariables."${params.environment}"['ARM_CLIENT_ID']
                    env.ARM_CLIENT_SECRET = envvariables."${params.environment}"['ARM_CLIENT_SECRET']
                    env.ARM_TENANT_ID = envvariables."${params.environment}"['ARM_TENANT_ID']
                    env.TFVARS_INIT_PATH = envvariables."${params.environment}"['TFVARS_INIT_PATH']
                    env.TFVARS_PLAN_APPLY_PATH = envvariables."${params.environment}"['TFVARS_PLAN_APPLY_PATH']
                }
            }
        }
